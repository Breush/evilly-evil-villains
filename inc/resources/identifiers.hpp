...
enum class TextureID : uint8
{
    ...
    DUNGEON_SIDEBAR_TAB_TOOLS,
    DUNGEON_SIDEBAR_TAB_MONSTERS_CAGE,
    ...
    DUNGEON_TOOLS_ROOMS_BUILDER_ICON,
    DUNGEON_TOOLS_ROOMS_DESTROYER_ICON,
    DUNGEON_TOOLS_TRAPS_REMOVER_ICON,
    DUNGEON_TOOLS_FACILITIES_REMOVER_ICON,
    DUNGEON_INTER_VOID_ROOM,
    ...
    DUNGEON_INTER_OUTER_WALL_WEST,
    DUNGEON_INTER_OUTER_WALL_EAST,

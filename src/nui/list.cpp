...
List::List()
{
    ...
    // Header
    const auto& headerLeftTexture = context::context.textures.get("core/nui/list/header_left");
    const auto& headerRightTexture = context::context.textures.get("core/nui/list/header_right");
    const auto& headerMiddleTexture = context::context.textures.get("core/nui/list/header_middle");
    ...
    // Fill
    const auto& fillLeftTexture = context::context.textures.get("core/nui/list/fill_left");
    const auto& fillRightTexture = context::context.textures.get("core/nui/list/fill_right");
    const auto& fillMiddleTexture = context::context.textures.get("core/nui/list/fill_middle");
    ...
    // Bottom
    const auto& bottomLeftTexture = context::context.textures.get("core/nui/list/bottom_left");
    const auto& bottomRightTexture = context::context.textures.get("core/nui/list/bottom_right");
    const auto& bottomMiddleTexture = context::context.textures.get("core/nui/list/bottom_middle");

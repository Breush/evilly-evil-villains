...
void ImageButton::handleMouseMoved(const sf::Event& event, const sf::Vector2f& absPos, const sf::Vector2f& relPos)
{
    baseClass::handleMouseMoved(event, absPos, relPos);
